...
// Define la interfaz ModelProps
interface ModelProps extends React.PropsWithChildren<React.ComponentPropsWithoutRef<"group">> {
  item: {
    img: string | StaticImageData; // Ajusta según tu necesidad
    color: string[];
  };
  size: string;
}

function Iphone({ item, size, ...props }: ModelProps) {
